...
public class TracyPublisherDownTestPerf {
...
//		tomcat.destroy();
	...
	public void testPublisherDown() {
		...
		// TODO: Make a separate HTTP call to ensure publisher down does not adversly affect TCP stack 
		Tracy.clearContext();
	}
}
